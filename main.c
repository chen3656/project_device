...
void read_file(FILE* fd, FILE* fn, FILE* fp);
...
int main(int argc, char* argv[])
{
    ...
    printf("| 2) Gnerate Project Device List                       |\n");
    printf(" ------------------------------------------------------\n");
    ...
    switch (command)
    {
        ...
        case 2:
            ...
            read_file(fd, fn, fp);	// get device list
...
void display(char* file, int cols)
{
    ...
    {
        printf(" ");
        for (i = 0; i < max_length + 3; i++) printf("-");
        printf("\n");
